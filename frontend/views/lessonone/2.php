...
<body>
	<div class="contain clear header" style="margin-bottom:0">
		...
		<div class="header-menu-wrapper">
			...
			<a data-show-guest="" href="/lessonone/3" class="callout_btn secondary">下一节</a>
...
<div class="container public-container">
    ...
    <div class="section">
        ...
        <p class="remarks">面向零基础同学</p>
        <p class="message">学习以下CSS是怎么运作的，然后创建一个task0001.css的文件，并在task0001.html中引入它，然后我们对task0001.html做一些让他变得花哨一点的事情：</p>
        <ul>
        ...
        <p class="message">效果如下图：</p>
        <img src="/img/task0001_2.jpg"/>
    </div>
    <div class="section">
    ...
    <div class="section">
        <p class="subheading">2.3 参考资料</p>
        <ul>
            <li><a target="_blank" href="https://developer.mozilla.org/zh-CN/docs/Web/Guide/CSS/Getting_started">MDN CSS</a>的1，2，3节</li>
            <li><a target="_blank" href="http://w3school.com.cn/css/index.asp">w3school css</a></li>
            <li><a target="_blank" href="http://www.imooc.com/learn/9">慕课网HTML+CSS基础课程</a></li>
        </ul>
    </div>
</div>
<footer>
