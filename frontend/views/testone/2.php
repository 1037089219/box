...
<body>
	<div class="contain clear header" style="margin-bottom:0">
		...
		<div class="header-menu-wrapper">
			...
			<a data-show-guest="" href="/testone/3" class="callout_btn secondary">下一节</a>
...
<div class="container public-container">
    ...
    <div class="section">
        ...
        <ul>
            <li>基于第一个任务“零基础HTML编码”的代码，参考 <a target="_blank" href="/img/test1-02.jpg">示例图（点击查看）</a>，在步骤一的代码基础上增加CSS样式代码的编写.</li>
        </ul>
    </div>
    <div class="section">
